# Обратите внимание.
#
# В текущей реализации первого задания у Вас создается копия всех списков,
# что значительно увеличивает потребление памяти, на больших данных это может приводить к проблемам.
#
# Для проверки типов необходимо использовать функцию isinstance
#
...
if __name__ == '__main__':
    ...
    print('Задача 1.1')
    for item in FlatIteratorEasyWay(my_list_simple):
        print(item)
    print('*' * 25)
